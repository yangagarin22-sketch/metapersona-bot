...
SCENARIOS = {
    'Vlasta': {
        'greeting': (
            ...
            "Я — не просто ещё один чат-бот или классический минпромт для ИИ и скоро ты в этом быстро убедишься.\n"
        ...
        'limit_message': (
            ...
            "Осталось 20 мест\n"
            "Доступ на 7 дней: 1000 (перечеркнуто) 499,00 ₽.\n\n"
            "Меньше, чем чашка кофе и пончик за уверенность в завтрашнем дне.\n\n"
            "👉 [оплата через СБП)\n\n"
            "P.S. Это не «ещё один чат-бот или банальный промт для ИИ». Это обученный твой личный стратег.\n"
            "Решение за тобой."
        ),
