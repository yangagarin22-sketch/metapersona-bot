...
SCENARIOS = {
    'Vlasta': {
        ...
        'limit_message': (
            ...
            "Доступ на 7 дней: 499,00 ₽. Меньше, чем чашка кофе и пончик в день — за уверенность в завтрашнем дне.\n\n"
            "👉 [Оплатить через ЮКасса] (https://taplink.cc/vlasta)\n\n"
        ...
        'subscription_end_message': (
            ...
            "👉 [Приобрести доступ на 7 дней к Vlasta по цене 499,00 ₽] (https://taplink.cc/vlasta)\n\n"
