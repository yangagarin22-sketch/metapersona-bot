...
SCENARIOS = {
    'Vlasta': {
        'greeting': (
            ...
            "Если ты готова покорять новые вершины:\n"
            "- Глубже проработать аспекты отношений\n"
            "- Получать результаты и знать как влиять\n\n"
            "Тогда приступим: вот мой первый вопрос:"
        ),
        'questions': [
            ...
            "Вспомни последний спор или недопонимание. Что ты хотела донести до него, но он не услышал?\n\nОпиши одной фразой.\nНапример: «Мне нужна твоя поддержка, а не решение», «Я устала нести всё одна», «Моё мнение тоже важно», «Мне больно от твоего безразличия», «Свой вариант».",
            "И что ты сделала, когда поняла, что он не слышит?\n\нНапример: «Стала говорить громче и настойчивее», «Устала и замолчала», «Затаила обиду», «Начала злиться и перешла на упрёки», «Попыталась объяснить “по-другому”, но снова не вышло», «Сделала вид, что всё нормально», «Свой вариант».",
